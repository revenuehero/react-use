...
function useStateValidator(state, validator) {
    var initialState = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [
        void 0
    ];
    ...
    var _useState = _sliced_to_array(useState(initialState), 2), validity = _useState[0], setValidity = _useState[1];
